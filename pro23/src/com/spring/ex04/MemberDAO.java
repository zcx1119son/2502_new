...
public class MemberDAO {
	...
	/*
	 * public int updateMember(MemberVO memberVO) { sqlMapper = getInstance();
	 * SqlSession session = sqlMapper.openSession(); int
	...
	public List<MemberVO> searchMember(MemberVO memberVO){
		sqlMapper=getInstance(); SqlSession session=sqlMapper.openSession(); List
		list=session.selectList("mapper.member.searchMember", memberVO); return list;
	}
	...
	public List<MemberVO> foreachSelect(List nameList){
	 ...
	 public int  foreachInsert(List<MemberVO> memList){
	        ...
	        System.out.println("foreachInsert result:"+result);
	        session.commit();
	        return result ;        
	     }
