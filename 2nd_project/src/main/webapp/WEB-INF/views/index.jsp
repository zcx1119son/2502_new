...
<body>
    ...
    <div class="auth-buttons">
        <a href="/membersignup/loginfirst"><button class="btn-signup">회원가입</button></a>
        <a href="/login/login.do"><button class="btn-login">로그인</button></a>
    </div>
    ...
    <div class="middle-section">
        <img src="/images/main_image002.png" alt="중간 이미지" />
        <div class="middle-text">"</div>
        <div class="middle-text">모든 유통의 흐름을 한눈에,</div>
        <div class="middle-subtext">당신의 스케줄은 이제 예술이 됩니다.</div>
        <div class="middle-text">"</div>
    </div>
    ...
    <div class="bottom-section">
        <img src="/images/main_image003.png" alt="하단 이미지" />
    </div>
