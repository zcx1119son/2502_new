...
<div class="header-container">
    ...
    <div class="user-info">
        <button class="user-name-btn">
            <c:out value="${sessionScope.companyCode}"/> ||
            <c:out value="${sessionScope.companyName}"/> ||
            <c:out value="${sessionScope.companyOwnerName}"/>
        </button>
        <a href="/main">
...
<div class="navbar">
    ...
    <a href="/purchase">발주 계획</a>
    <a href="/product">상품 관리</a>
    <a href="/company">직원 조직도</a>
</div>
