...
<style>
    ...
    .navbar a {
        ...
        transition: background-color 0.2s, border-bottom 0.2s; /* 호버 및 활성화 시 트랜지션 */
    }

    /* 모든 네비게이션 링크에 대한 호버 스타일 (HOME처럼) */
    .navbar a:hover {
        background-color: #0033cc;
        border-radius: 4px;
    }

    /* ★★★ 활성화된 탭에 대한 CSS (요청하신 이미지처럼 하단 흰색 선) ★★★ */
    .navbar a.active {
...
<div class="header-container">
    ...
    <div class="user-info">
        <button class="user-name-btn">
            <c:out value="${sessionScope.user.companyCode}"/> ||
...
<div class="navbar">
    <a href="/home">HOME</a>
    <a href="${pageContext.request.contextPath}/master/request_list.do">기업 관리</a>
</div>
