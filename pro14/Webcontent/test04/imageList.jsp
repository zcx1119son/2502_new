	...
	<ul class="lst_type">
	    ...
	    <c:forEach var="i" begin="1" end="5" step="1">
	    	 <li>
	        	...
	        	<img src='sury.png' width='90' height='90' alt='' /></a>
	        	<a href='#' ><strong>이미지 이름: 수리${i} </strong></a>
	        	<a href='#' >
	    	 ...
	    	 <li>
	        	<a href='#' style='margin-left:50px'  >
	        	<img src='hoodi.png' width='90' height='90' alt='' /></a>
	        	<a href='#' ><strong>이미지 이름: 후디${i} </strong></a>
	        	<a href='#' >
	        		<input type="checkbox" id="imageCheck"/>
	        	</a>
	        </li>
